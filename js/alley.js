...
import { subscribe } from './ticker.js?v=4.63';
import { scramble, scrambleOnApproach } from './scramble.js?v=4.63';
import { holdNarration, forceNarrate } from './narrator.js?v=4.63';
